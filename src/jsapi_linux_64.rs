...
pub struct AutoStableStringChars {
    ...
    pub ownChars_: Maybe<Vector<::std::os::raw::c_uchar, TempAllocPolicy>>,
...
fn bindgen_test_layout_AutoStableStringChars() {
    assert_eq!(::std::mem::size_of::<AutoStableStringChars>() , 104usize);
...
fn bindgen_test_layout_ErrorReport() {
    assert_eq!(::std::mem::size_of::<ErrorReport>() , 280usize);
    assert_eq!(::std::mem::align_of::<ErrorReport>() , 8usize);
}
extern "C" {
    fn _ZN2js11ErrorReport4initEP9JSContextN2JS6HandleINS3_5ValueEEENS0_16SniffingBehaviorE(this:
                                                                                                *mut ErrorReport,
                                                                                            cx:
                                                                                                *mut JSContext,
                                                                                            exn:
...
impl ErrorReport {
    ...
    pub unsafe fn init(&mut self, cx: *mut JSContext, exn: HandleValue,
                       sniffingBehavior: ErrorReport_SniffingBehavior)
     -> bool {
        _ZN2js11ErrorReport4initEP9JSContextN2JS6HandleINS3_5ValueEEENS0_16SniffingBehaviorE(&mut *self,
                                                                                             cx,
                                                                                             exn,
                                                                                             sniffingBehavior)
    }

...
extern "C" {
    ...
    fn _ZN27JSAutoStructuredCloneBuffer5clearEv(this:
                                                    *mut JSAutoStructuredCloneBuffer);
    fn _ZN27JSAutoStructuredCloneBuffer4copyEPKmmj(this:
                                                       *mut JSAutoStructuredCloneBuffer,
                                                   data: *const u64,
                                                   nbytes: size_t,
                                                   version: u32) -> bool;
    fn _ZN27JSAutoStructuredCloneBuffer5adoptEPmmj(this:
                                                       *mut JSAutoStructuredCloneBuffer,
                                                   data: *mut u64,
                                                   nbytes: size_t,
                                                   version: u32);
    fn _ZN27JSAutoStructuredCloneBuffer5stealEPPmS0_Pj(this:
                                                           *mut JSAutoStructuredCloneBuffer,
                                                       datap: *mut *mut u64,
                                                       nbytesp: *mut size_t,
                                                       versionp: *mut u32);
...
impl JSAutoStructuredCloneBuffer {
    ...
    pub unsafe fn copy(&mut self, data: *const u64, nbytes: size_t,
                       version: u32) -> bool {
        _ZN27JSAutoStructuredCloneBuffer4copyEPKmmj(&mut *self, data, nbytes,
                                                    version)
    }
    #[inline]
    pub unsafe fn adopt(&mut self, data: *mut u64, nbytes: size_t,
                        version: u32) {
        _ZN27JSAutoStructuredCloneBuffer5adoptEPmmj(&mut *self, data, nbytes,
                                                    version)
    }
    #[inline]
    pub unsafe fn steal(&mut self, datap: *mut *mut u64, nbytesp: *mut size_t,
                        versionp: *mut u32) {
        _ZN27JSAutoStructuredCloneBuffer5stealEPPmS0_Pj(&mut *self, datap,
                                                        nbytesp, versionp)
    }
    #[inline]
